...
<div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow">
    ...
    <form class="form-signin" method="post" action="connexion.php">
        ...
        <div class="form-label-group">
            ...
            <input type="email" id="inputEmail3" class="form-control" placeholder="Adresse e-mail" name="email" required
                autofocus>
        ...
        <div class="form-label-group">
            ...
            <input type="password" id="inputPassword3" class="form-control" placeholder="Mot de passe" name="password"
                required>
